                                ...
                                <div class="col-lg-6 col-md-7 col-sm-6 col-xs-12">
                                    <div class="header-top-menu tabl-d-n">
                                        <ul class="nav navbar-nav mai-top-nav">
                                            ...
                                            <li class="nav-item"><a href="#" class="nav-link">Panduan Mutasi</a>
                                            </li>
                                            <li class="nav-item"><a href="#" class="nav-link">Bantuan</a>
                                            </li>

                                            <li class="nav-item"><a href="#" class="nav-link">Pengumuman</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                        ...
                                                        <li>
                                                            <a href="#">
                                                                ...
                                                                <div class="message-content">
                                                                    <span class="message-date">15 Auggitpt</span>
                                                                    <h2>Advanda Cro</h2>
                        ...
                        <div class="breadcome-list single-page-breadcome">
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="breadcome-heading"> <br> <br>
