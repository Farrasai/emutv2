...
<div class="all-content-wrapper">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="product-status-wrap">
                        ...
                        <div class="asset-inner">
                            <table id="table" class="table table-hover table-bordered table-hover" data-toggle="table" data-height="460" data-toggle="table" data-pagination="true" data-search="true" data-show-export="true" data-key-events="true" data-cookie="true" data-cookie-id-table="saveId" data-toolbar="#toolbar">
                                <thead>
                                    <tr>
    ...
    <script>
        ...
        var edit = '<?php echo $this->session->flashdata('edit') ?>';
        if (tambah.length != 0) {
            if (tambah) {
                swal({
                    title: "Sukses!",
